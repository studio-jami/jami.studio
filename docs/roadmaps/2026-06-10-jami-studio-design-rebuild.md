...
**Active lane:** `design/noir`
**Template / reference:** Noir
**Primary aesthetic lane:** A — high-contrast dark agency
**Primary accent (brand hex):** `#a1704f` copper — authored as `color.accent` → `--accent`/`--primary`; dial family `amber`
**Framer bridge key:** `noir` → `tools/framer-bridge/out/noir.json`
